	...
	<footer class="layout-footer">
		<div class="layout-footer__content">
			...
			<address class="layout-footer__info-wrap">
				...
				<dl class="layout-footer__info">
					<span class="layout-footer__info__item"><dt>NICEPAY
							안전거래 서비스</dt>
						<dd>
							고객님의 안전거래를 위해 현금 결제 시, 저희 사이트에서 가입한 구매안전 서비스를 이용할 수 있습니다.&nbsp;<a
								class="layout-footer__info__item__link"
								href="https://pg.nicepay.co.kr/issue/IssueEscrow.jsp?Mid=bucketplam&amp;CoNo=1198691245"
								target="_blank" rel="noopener noreferrer">가입 확인</a>
						</dd></span>
				</dl>
			...
			<p class="layout-footer__copyright">Copyright © 2014 - 2020 by
				Bucketplace, Inc. All rights reserved</p>
		</div>
	</footer>
</body>
</html>