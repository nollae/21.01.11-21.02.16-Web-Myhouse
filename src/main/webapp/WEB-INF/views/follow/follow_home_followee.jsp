...
<div class="myhome-nav">
  <nav class="page-navigation myhome-nav__contents">
    <ul>
        <li class="page-navigation__item page-navigation__item--active"><a target="_self" href="http://localhost:9000/myhouse/follow_home_followee.do">팔로잉</a></li>
  <li class="page-navigation__item"><a target="_self" href="http://localhost:9000/myhouse/follow_home_follower.do">팔로워</a></li>
...
<div id="follow_content">
    ...
    <div class="user" id="11239104">
    <a target="_blank" href="/users/11239104">
        <div class="image" style="background-image: url('https://image.ohou.se/image/central_crop/bucketplace-v2-development/uploads-users-profile_images-160738942819805053.jpeg/320/320')"></div>
        <div class="name">shin기린</div>
</a>
        <div class="button follow user_11239104">
                <a data-remote="true" href="/users/11239104/follow"></a>
        </div>
</div>
<div class="user" id="11910615">
    <a target="_blank" href="/users/11910615">
        ...
        <div class="button follow user_11910615 active">
                <a data-remote="true" href="/users/11910615/unfollow"></a>
        </div>
</div>
